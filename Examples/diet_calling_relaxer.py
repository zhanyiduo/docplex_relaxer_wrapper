##Examples/diet_calling_relaxer.py
...
def build_diet_model(**kwargs):
    ...
    mdl.add_constraint(500000 <= amount,'Constraints it is infeasible:')#add an infeasible constraints
    # Minimize cost
...
if __name__ == '__main__':
    ...
    if not mdl.solve():
        ...
        solution, relaxations = relax_solve(mdl,'named')
        print(relaxations)
    else:
